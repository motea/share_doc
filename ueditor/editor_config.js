...
(function () {
    ...
    URL = window.UEDITOR_HOME_URL||"/share_doc/ueditor/";
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["forecolor","underline","italic","bold","fontsize","justifyleft","justifycenter","justifyright","justifyjustify","undo","redo","insertunorderedlist","insertorderedlist","unlink","link","emotion","backcolor","pasteplain"]]
